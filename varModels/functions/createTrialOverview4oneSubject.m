function createTrialOverview4oneSubject(workingDirectory, rootDirectory, path2setupFiles, condition, prefix, timeNormFlag, trialType, Model2Use)
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Create reports for one single subject %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This file creates for all plots in one simulation folder (of a single subject) a
...
% Find and add all Simulation output from the working directory for one condition to one output file and save plots.
subResults = analyzeSubjectFiles(workingDirectory, rootDirectory, path2setupFiles, condition, prefix, timeNormFlag, trialType, Model2Use);
