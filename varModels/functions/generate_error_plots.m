function [error, hfig] = generate_error_plots(path2IKerrorReport,path2ActivationErrorReport,path2ForceErrorReport,path2IDErrorReport,statesFileName, cTO, TO)
% Lerner version!
...
%% StaticOptimization Muscle Reserve Activations
STO = struct();
...
%% StaticOptimization Actuator Reserve
FORCE = struct();
