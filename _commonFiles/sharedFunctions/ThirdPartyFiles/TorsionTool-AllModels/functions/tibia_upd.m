...
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,3}.attached_geometry...
        .Mesh{1,1}.mesh_file = cTibiaR;
else
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,8}.attached_geometry...
        .Mesh{1,1}.mesh_file = cTibiaL;
end
...
%change the name of the tibia in the gait2392 model file
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,4}.attached_geometry...
        .Mesh.mesh_file = cTalusR;
else
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,9}.attached_geometry...
        .Mesh.mesh_file = cTalusL;
end
...
%change the name of the tibia in the gait2392 model file
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,5}.attached_geometry...
        .Mesh.mesh_file = cCalcnR;
else
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,10}.attached_geometry...
        .Mesh.mesh_file = cCalcnL;
end
...
%change the name of the tibia in the gait2392 model file
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,6}.attached_geometry...
        .Mesh.mesh_file = cToesR;
else
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,11}.attached_geometry...
        .Mesh.mesh_file = cToesL;
end
