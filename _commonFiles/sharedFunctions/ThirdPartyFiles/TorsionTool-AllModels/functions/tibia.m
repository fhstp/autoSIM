...
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,3}.VisibleObject...
...
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,4}.VisibleObject...
        .GeometrySet.objects.DisplayGeometry{1,1}.geometry_file.Text = cTalusR;


else
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,10}.VisibleObject...
        .GeometrySet.objects.DisplayGeometry{1,1}.geometry_file.Text = cTalusL;
end
...
if strcmp(answerLeg, rightbone) == 1;
    ...
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,13}.VisibleObject...
