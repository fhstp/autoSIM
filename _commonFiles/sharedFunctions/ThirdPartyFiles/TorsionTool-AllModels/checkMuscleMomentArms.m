function momentArmsAreWrong = checkMuscleMomentArms(modelFilename, motionFilename, threshold)
%CHECKMUSCLEMOMENTARM Summary of this function goes here
%   This script checks the muscle moment arms of a model during a movement
%   and checks for discontinuties (e.g. detects when muscles pull through wrap
%   objects)

%    Authors: Willi Koller   (Mai 2023)                                   %
%       University of Vienna, Neuromechanics Research Group               %
%       web:   neuromechanics.univie.ac.at                                %
%       email: willi.koller@univie.ac.at                                  %

% MATLAB has to be configured for OpenSim scripting, see this link:       %
