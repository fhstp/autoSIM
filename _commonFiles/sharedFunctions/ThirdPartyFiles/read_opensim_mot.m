...
%header : struct
%
% Change log:   B. Horsak (19.04.2021: added one line to make sure that 
%               '-nan(ind)' is recognized as 'nan'
%==========================================================================
...
while ((feof(fid)==0)&(i<nr))
     i=i+1;
     line=fgetl(fid);
     line=strrep( line , '-nan(ind)' , 'nan' ); % make sure that the '-nan(ind)' is recognized as a 'nan' (B. Horsak)
