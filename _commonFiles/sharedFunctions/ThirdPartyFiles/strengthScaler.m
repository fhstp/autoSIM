...
% Edited: by Brian Horsak(added load plugin) - 24.08.2022

function strengthScaler(scaleFactor, apiPath, Model_In, Model_Out)
...
% Load plugIn if user defined one
if~isempty(apiPath)
...
% the GUI navigator
Model2.setName('Comak-MuscleScaled');
